const AboutPage = () => {
  return (
    <main className="px-8 sm:px-24 w-full flex flex-col min-h-screen items-center py-20 leading-7">
      <h1 className="w-1/2 mb-5 text-blue-900 text-2xl">About this app</h1>
      <div className="w-1/2">
