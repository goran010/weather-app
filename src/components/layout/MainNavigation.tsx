...
const MainNavigation = () => {
  ...
  return (
    <header className="px-8 sm:px-28 sm:relative sticky top-0 bg-white">
      <div className="justify-between py-4 pb-6 flex flex-col gap-5 lg:grid grid-cols-12 grid-rows-5 gap-x-16 content-end">
